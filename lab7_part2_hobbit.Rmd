---
title: 'Part 2: text mining & analysis'
...
```{r}
hobbits_nonstop_words <- hobbit_tokens %>% 
  anti_join(stop_words) 

nonstop_counts <- hobbits_nonstop_words %>% 
  count(chapter, word)
```
...
```{r}
hobbit_afinn <- hobbits_nonstop_words %>% 
...
```{r}
hobbit_nrc <- hobbits_nonstop_words %>% 
